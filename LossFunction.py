...
class LossFunction(nn.Module):
    ...
    def forward(self, predicted_image, ground_truth_image, pointcloud_features=None):
        """
        L = (1 − 𝜆)L1 + 𝜆LD-SSIM
    ...
    def _regularization_loss(self, pointcloud_features):
